...
const EmployerAllJob: React.FC<EmployerAllJobProps> = ({ data }) => {
    ...
    return (
        <div className="flex flex-wrap items-center justify-center gap-3">
            {
                data.map((job) => {
                    return <div key={job._id} className='flex flex-col gap-3 shadow-[0px_0px_5px_rgba(0,0,0,0.85)] rounded-md p-3 hover:shadow-[0px_0px_5px_rgba(255,255,255,0.8)] hover:scale-105 '>
                        <div className="flex items-center justify-between">
                            <h2 className='text-bold text-xl font-bold'>{job.title.charAt(0).toUpperCase() + job.title.slice(1)}</h2>
                            <div className="flex items-center gap-2">
                                <Edit className='hover:bg-[rgba(0,0,0,0.1)] w-8 h-8 active:scale-90 cursor-pointer hover:text-[#19faf3] p-1 rounded ' />
                                ...
                                <AlertDialog>
                                    ...
                                    <AlertDialogContent>
                                        ...
                                        <AlertDialogFooter>
                                            ...
                                            <Button className='p-0 bg-[red] !important'>
