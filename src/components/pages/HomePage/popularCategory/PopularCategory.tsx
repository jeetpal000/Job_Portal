      ...
      <div className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 xs:grid-cols-2  mx-auto place-items-center">
        {
          popularCategory.map((item) =>{
            ...
            return <div key={item.title} className="shadow-md px-6 py-4 md:p-4 rounded-md flex gap-6 items-center  justify-between w-full bg-linear-45 from-transparent via-[#d2dfff] to-transparent">
